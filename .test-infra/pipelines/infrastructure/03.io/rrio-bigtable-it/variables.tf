...
variable "resource_name_basis" {
  type        = string
  description = "The resource naming basis used to name provisioned resources"
}

variable "column_family" {
  type        = string
  description = "The column family to allocate in the provisioned table"
}
